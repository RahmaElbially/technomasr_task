...
const RegisterForm: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formData.password) validationErrors.password = 'يجب إدخال كلمة المرور';
    if (formData.password.length < 6) validationErrors.password= 'يجب أن تحتوي كلمة المرور علي 6 أحرف علي الأقل'
